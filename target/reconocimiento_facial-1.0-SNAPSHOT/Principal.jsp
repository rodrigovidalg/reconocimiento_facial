...
<%
   // Verificar si la sesión es nula o si el atributo usuarioId no existe
   if (session == null || session.getAttribute("usuarioId") == null || session.getAttribute("nombreUsuario") == null) {
       response.sendRedirect("index.jsp");
       return;
   }
   
   // Obtener el ID del usuario y el nombre de usuario desde la sesión
...
<html lang="es">
   ...
   <body>
      <div id="sideMenu" class="side-menu">
         ...
         <a href="ReporteUsuario.jsp" target="frame"><i class="bi bi-file-earmark-bar-graph"></i> Reportes Usuario</a>
      ...
      <nav class="navbar navbar-dark fixed-top">
         <div class="container-fluid">
            ...
            <span class="navbar-brand ms-2">Bienvenido, <%= nombreUsuario %></span>
            <div class="dropdown ms-auto">
               ...
               <ul class="dropdown-menu dropdown-menu-end">
                  <li><a class="dropdown-item" href="#"><i class="bi bi-person"></i> <%= nombreUsuario %></a></li>
