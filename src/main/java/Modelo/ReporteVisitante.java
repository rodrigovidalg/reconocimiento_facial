...
public class ReporteVisitante {
    ...
    public ReporteVisitante(){}
    public ReporteVisitante(int id, String nombreCompleto, String fechaHora, String zonaAcceso, int resultado, String metodo, byte[] imagen) {
        this.id = id;
