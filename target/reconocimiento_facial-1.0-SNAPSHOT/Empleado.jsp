<%-- 
    Document   : Empleado
    Created on : 30 mar 2025, 11:36:05
    Author     : DELL
--%>
            ...
            <div class="card shadow-lg">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center mb-4">
                        ...
                        <a href="Visitante.jsp" class="btn btn-secondary me-3"><i class="bi bi-briefcase-fill"></i> Nuevo Visitante</a>
                        ...
                        <table class="table table-striped table-hover custom-table">
                            <thead class="table-primary">
                                <tr class="text-center">
                                    ...
                                    <th>Departamento</th><th>Puesto</th><th>Cod. Facial</th><th>Foto</th>
                                    <th>Estado</th>
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="Controlador?menu=Empleado" method="post" class="form-group" enctype="multipart/form-data">
